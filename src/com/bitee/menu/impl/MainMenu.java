...
public class MainMenu implements Menu {
    ...
    public static final String PROMPT_COMMAND= "Please, enter number in console to proceed." + System.lineSeparator();
    public static final String CONSTANT_OPTIONS ="3. Product Catalog" +System.lineSeparator() +"4. My Orders" + System.lineSeparator()
            +"5. Settings" + System.lineSeparator() + "6. Customer List";
    private static final String MAIN_MENU_TEXT_FOR_LOGGED_OUT_USER = PROMPT_COMMAND
            +"1. Sign Up" + System.lineSeparator() + "2. Sign In" + System.lineSeparator()
            +CONSTANT_OPTIONS;


    private static final String MAIN_MENU_TEXT_FOR_LOGGED_IN_USER = PROMPT_COMMAND
            +"1. Sign Up" +System.lineSeparator() + "2. Sign Out" +System.lineSeparator()
            +CONSTANT_OPTIONS;
